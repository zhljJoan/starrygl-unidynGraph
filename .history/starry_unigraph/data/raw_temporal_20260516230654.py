...
def _build_snapshot_node_features(
    ...
    def _get_batch_snapshots(self, data: np.ndarray):
        ...
        # Keep temporal order before batching.
...
def build_snapshot_dataset_from_events(events: RawTemporalEvents, snaps: int, input_x = None, input_y = None,windows_slices=None) -> dict[str, Any]:

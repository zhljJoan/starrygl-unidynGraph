...
def build_snapshot_dataset_from_events(events: RawTemporalEvents, snaps: int, input_x = None, input_y = None,windows_slices=None,use_snapshots=None) -> dict[str, Any]:

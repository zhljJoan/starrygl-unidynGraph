...
class PartitionData:
    ...
    def edge_events(self, snapshot_indexs: Optional[int|slice] = None) -> Tuple[Tensor, Tensor, Tensor, Tensor]:
        ...
        start_idx = 0 if snapshot_indexs is None else snapshot_indexs.start if isinstance(snapshot_indexs, slice) else snapshot_indexs
        end_idx = len(self) if snapshot_indexs is None else (snapshot_indexs + 1)

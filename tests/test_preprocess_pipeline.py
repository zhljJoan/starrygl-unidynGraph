...
def test_pipeline_forwards_preserve_replica_history(monkeypatch, tmp_path: Path) -> None:
    captured = {}
    ...
    def fake_build_dist_plan(**kwargs):
        return {"world_size": 1, "num_nodes": 2}

    def fake_build_all_rank_artifacts(**kwargs):
        captured["preserve_replica_history"] = kwargs.get("preserve_replica_history")
        return kwargs["dist_plan"], [{"rank": 0}]
    ...
    assert captured["preserve_replica_history"] is True

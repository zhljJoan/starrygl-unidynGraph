"""Distributed feature exchange for CTDG online runtime.

:class:`CTDGFeatureRoute` wraps ``all_to_all_single`` for exchanging node
memory / feature vectors between ranks.  :class:`AsyncExchangeHandle`
provides a non-blocking API for overlapping communication with compute.
"""
...
class CTDGFeatureRoute:
    ...
    def exchange(
        ...
        """Exchange node features with all peers via all-to-all.

...
class Batch:
    ...
    commit_memory_nodes: Optional[Tensor] = None
    commit_memory_rows: Optional[Tensor] = None
    commit_memory_ts: Optional[Tensor] = None
    commit_memory_target_index: Optional[Tensor] = None
    commit_memory_target_ptr: Optional[Tensor] = None
    commit_memory_source_pos: Optional[Tensor] = None
    commit_mailbox_nodes: Optional[Tensor] = None
    commit_mailbox_self_rows: Optional[Tensor] = None
    commit_mailbox_peer_rows: Optional[Tensor] = None
    commit_mailbox_edge_pos: Optional[Tensor] = None
    commit_mailbox_ts: Optional[Tensor] = None
    commit_mailbox_target_index: Optional[Tensor] = None
    commit_mailbox_target_ptr: Optional[Tensor] = None
    commit_mailbox_source_pos: Optional[Tensor] = None
    commit_memory_root_pos: Optional[Tensor] = None
    commit_mailbox_self_root_pos: Optional[Tensor] = None
    commit_mailbox_peer_root_pos: Optional[Tensor] = None
